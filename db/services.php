...
$functions = array(
    ...
    'local_mobile_core_message_create_contacts' => array(
        'classname'   => 'local_mobile_external',
    ...
    'local_mobile_core_message_delete_contacts' => array(
        'classname'   => 'local_mobile_external',
    ...
    'local_mobile_core_message_block_contacts' => array(
        'classname'   => 'local_mobile_external',
    ...
    'local_mobile_core_message_unblock_contacts' => array(
        'classname'   => 'local_mobile_external',
    ...
    'local_mobile_core_message_get_contacts' => array(
        'classname'   => 'local_mobile_external',
        'methodname'  => 'core_message_get_contacts',
        'classpath'   => 'local/mobile/externallib.php',
...
$services = array(
   'Moodle Mobile additional features service'  => array(
        'functions' => array (
            ...
            'local_mobile_core_message_create_contacts',
            'local_mobile_core_message_delete_contacts',
            'local_mobile_core_message_block_contacts',
