...
class local_mobile_external extends external_api {
     ...
     * @since 2.5
     */
    public static function core_message_create_contacts_parameters() {
        return new external_function_parameters(
            array(
                'userids' => new external_multiple_structure(
                    new external_value(PARAM_INT, 'User ID'),
     ...
     * @since 2.5
     */
    public static function core_message_create_contacts($userids) {
        $params = array('userids' => $userids);
        $params = self::validate_parameters(self::core_message_create_contacts_parameters(), $params);
        $warnings = array();
     ...
     * @since 2.5
     */
    public static function core_message_create_contacts_returns() {
     ...
     * @since 2.5
     */
    public static function core_message_delete_contacts_parameters() {
        return new external_function_parameters(
            array(
                'userids' => new external_multiple_structure(
                    new external_value(PARAM_INT, 'User ID'),
     ...
     * @since 2.5
     */
    public static function core_message_delete_contacts($userids) {
        $params = array('userids' => $userids);
        $params = self::validate_parameters(self::core_message_delete_contacts_parameters(), $params);
        foreach ($params['userids'] as $id) {
     ...
     * @since 2.5
     */
    public static function core_message_delete_contacts_returns() {
        return null;
    }
    /**
     ...
     * @since 2.5
     */
    public static function core_message_block_contacts_parameters() {
        return new external_function_parameters(
            array(
                'userids' => new external_multiple_structure(
                    new external_value(PARAM_INT, 'User ID'),
     ...
     * @since 2.5
     */
    public static function core_message_block_contacts($userids) {
        $params = array('userids' => $userids);
        $params = self::validate_parameters(self::core_message_block_contacts_parameters(), $params);
        $warnings = array();
        foreach ($params['userids'] as $id) {
     ...
     * @since 2.5
     */
    public static function core_message_block_contacts_returns() {
        return new external_warnings();
    }
    /**
     ...
     * @since 2.5
     */
    public static function core_message_unblock_contacts_parameters() {
        return new external_function_parameters(
            array(
                'userids' => new external_multiple_structure(
                    new external_value(PARAM_INT, 'User ID'),
     ...
     * @since 2.5
     */
    public static function core_message_unblock_contacts($userids) {
        $params = array('userids' => $userids);
        $params = self::validate_parameters(self::core_message_unblock_contacts_parameters(), $params);
        foreach ($params['userids'] as $id) {
     ...
     * @since 2.5
     */
    public static function core_message_unblock_contacts_returns() {
        return null;
    }
    /**
     ...
     * @since 2.5
     */
    public static function core_message_get_contacts_parameters() {
     ...
     * @since 2.5
     */
    public static function core_message_get_contacts() {
        global $CFG;
        require_once($CFG->dirroot . '/user/lib.php');
     ...
     * @since 2.5
     */
    public static function core_message_get_contacts_returns() {
        return new external_single_structure(
            array(
